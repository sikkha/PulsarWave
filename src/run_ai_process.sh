...
python3 $HOME/ai_process_tweet.py 1> /tmp/j1.txt 2> /tmp/j2.txt
...
cat /tmp/j1.txt >> /home/sikkha/output2.txt
cat /tmp/process_tweet.txt >> $HOME/accu_process_tweet.txt
python3 $HOME/send_email2.py "Your Processed Tweet" < /tmp/process_tweet.txt
